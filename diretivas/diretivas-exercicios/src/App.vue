<template>
	<div id="app">
		...
		<hr>
		<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 300}">Usando diretiva local personalizada.</p>
		<p v-destaque-local.atrasar="{cor1: 'green', atraso: 5000}">Usando diretiva local personalizada.</p>
